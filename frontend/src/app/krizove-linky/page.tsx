  ...
  return (
    <div className="section">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-12">
          <div className="icon-box icon-box-secondary icon-box-lg mb-6">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Phone and Tags Layout */}
                  <div className="flex flex-col sm:flex-row gap-4">
                    {/* Phone - Left Side */}
                    {line.phones && line.phones.length > 0 && (
                      <div className="flex-shrink-0 sm:self-stretch">
                        <a
                          href={`tel:${getFirstPhone(line.phones)}`}
                          className="btn-secondary text-base w-full sm:h-full min-w-[225px]"
                        >
