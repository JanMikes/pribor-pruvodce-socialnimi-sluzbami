        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-primary-100 max-w-2xl mx-auto mb-10 leading-relaxed">
              Informační portál pro občany města Příbor. Najdete zde pomoc a podporu
              v různých životních situacích.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/zivotni-situace"
                className="group inline-flex items-center px-8 py-4 bg-white text-primary-700 font-semibold rounded-2xl hover:bg-primary-50 shadow-lg shadow-primary-900/20 hover:shadow-xl transition-all hover:-translate-y-0.5"
              >
                Potřebuji pomoc
              ...
              <Link
                href="/krizove-linky"
                className="group inline-flex items-center px-8 py-4 bg-secondary-500 text-white font-semibold rounded-2xl hover:bg-secondary-600 shadow-lg shadow-secondary-500/30 hover:shadow-xl transition-all hover:-translate-y-0.5"
              >
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-stone-800 group-hover:text-primary-700 transition-colors mb-1">
                      {situation.name}
                    </h3>
