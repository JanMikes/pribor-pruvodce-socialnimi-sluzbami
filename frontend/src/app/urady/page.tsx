...
import { ensureProtocol } from '@/lib/types';
  ...
  return (
    <div className="section">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-12">
          <div className="icon-box icon-box-authority icon-box-lg mb-6">
            ...
            >
              ...
              <div className="bg-authority-50 px-6 py-5 border-b border-authority-100">
                <div className="flex items-start gap-4">
                  <div className="icon-box icon-box-authority icon-box-lg !from-authority-200 !to-authority-100">
                    ...
                    <div className="space-y-1 text-sm text-stone-600">
                      ...
                      {authority.website && (
                        <div className="flex items-center gap-2">
                          ...
                          <a href={ensureProtocol(authority.website)} target="_blank" rel="noopener noreferrer" className="hover:text-authority-600 transition-colors">
                            {authority.website}
                          </a>
                        </div>
                      )}
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        {department.phone && (
                          <div className="flex items-center gap-2 text-stone-600">
                            ...
                            <a href={`tel:${department.phone}`} className="hover:text-authority-600 transition-colors">
                              {department.phone}
                            </a>
                          </div>
                        )}
                        {department.email && (
                          <div className="flex items-center gap-2 text-stone-600">
                            ...
                            <a href={`mailto:${department.email}`} className="hover:text-authority-600 transition-colors">
                              {department.email}
                            </a>
                          </div>
                        )}
